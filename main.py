...
def procesar_datos():
    url = "https://opendata.vlci.valencia.es/dataset/ab058cf8-ad3e-4d9c-ac89-0c6367ecf351/resource/c81b69e6-c082-44dc-acc6-66fc417b4e66/download/google_transit2026-09-15.zip"
    temp_dir = "temp_txt"
    output_dir = "data_csv"
    
    # 1. Descargar y extraer
    print("Accediendo a los datos de EMT...")
